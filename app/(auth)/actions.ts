...
export async function login(_: AuthState, formData: FormData): Promise<AuthState> {
  if (!isSupabaseConfigured()) return { error: "Configure o Supabase no arquivo .env.local para habilitar o acesso." };
...
export async function signup(_: AuthState, formData: FormData): Promise<AuthState> {
  if (!isSupabaseConfigured()) return { error: "Configure o Supabase no arquivo .env.local para habilitar o cadastro." };
